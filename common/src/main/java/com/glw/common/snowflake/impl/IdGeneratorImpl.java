package com.glw.common.snowflake.impl;

import com.glw.common.config.IdConfig;
import com.glw.common.snowflake.IdGenerator;
import com.glw.common.snowflake.SnowFlakeConstants;
 ...
 */
@Slf4j
public class IdGeneratorImpl implements IdGenerator, SnowFlakeConstants {
    ...
    public CommandLineRunner init() {
        return (args -> {
            log.info("Init IdGenerator <<< [dataCenterId] = {}, [machineId] = {}", idConfig.getDataCenterId(), idConfig.getMachineId());
            initDataCenterAndMachine(idConfig.getDataCenterId(), idConfig.getMachineId());
        });
    }
}
